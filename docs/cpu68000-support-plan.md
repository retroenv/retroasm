...
1. Exact match against `cpu68000.Instructions` map
...
```
pkg/arch/cpu68000/
  cpu68000.go                              - Architecture adapter (New, Instruction, ParseIdentifier, delegates)
  cpu68000_test.go                         - Integration tests (14 test functions)
  assembler/
