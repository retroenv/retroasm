...
var assignAddressTests = []struct {
...
}{
	{
		name: "NOP is 2 bytes",
		resolved: parser.ResolvedInstruction{
			Instruction: cpu68000.Instructions[cpu68000.NOPName],
		},
		wantSize: 2,
	},
	{
		name: "RTS is 2 bytes",
		resolved: parser.ResolvedInstruction{
			Instruction: cpu68000.Instructions[cpu68000.RTSName],
		},
		wantSize: 2,
	},
	{
		...
		resolved: parser.ResolvedInstruction{
			Instruction: cpu68000.Instructions[cpu68000.ILLEGALName],
		},
		wantSize: 2,
	},
	{
