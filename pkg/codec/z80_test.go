...
func TestZ80Codec_RecordsInstructionRelocations(t *testing.T) {
	t.Parallel()
	...
	assert.Equal(t, []ast.Relocation{
		...
		{EntryIndex: 2, ByteOffset: 2, Kind: ast.AbsoluteRelocation, Expression: ast.NewSymbolExpression("target", 1, ast.FullAddress), Width: ast.WidthWord, ByteOrder: ast.ByteOrderLittle},
		...
		{EntryIndex: 5, ByteOffset: 2, Kind: ast.AbsoluteRelocation, Expression: ast.NewSymbolExpression("target", 0, ast.FullAddress), Width: ast.WidthByte, ByteOrder: ast.ByteOrderLittle},
		{EntryIndex: 6, ByteOffset: 2, Kind: ast.AbsoluteRelocation, Expression: ast.NewSymbolExpression("target", 0, ast.FullAddress), Width: ast.WidthByte, ByteOrder: ast.ByteOrderLittle},
		{EntryIndex: 6, ByteOffset: 3, Kind: ast.AbsoluteRelocation, Expression: ast.NewSymbolExpression("target", 3, ast.FullAddress), Width: ast.WidthByte, ByteOrder: ast.ByteOrderLittle},
		{EntryIndex: 7, ByteOffset: 2, Kind: ast.AbsoluteRelocation, Expression: ast.NewSymbolExpression("target", 0, ast.FullAddress), Width: ast.WidthByte, ByteOrder: ast.ByteOrderLittle},
